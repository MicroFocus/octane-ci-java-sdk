...
public class FetchHandlerTests {
    ...
    public void githubCloudTest() {
        ...
        Assertions.assertEquals("https://api.github.com/repos/jenkinsci/hpe-application-automation-tools-plugin", result, "getRepoApiPath for https failed");

        result = handler.getApiPath("https://github.com/jenkinsci/hpe-application-automation-tools-plugin.git");
        Assertions.assertEquals("https://api.github.com", result, "getApiPath for https failed");
    }
    ...
    public void githubServerTest() {
        ...
        Assertions.assertEquals("https://github.houston.softwaregrp.net/api/v3/repos/MQM/mqm", result, "getRepoApiPath for https failed");


        result = handler.getApiPath("https://github.houston.softwaregrp.net/MQM/mqm.git");
        Assertions.assertEquals("https://github.houston.softwaregrp.net/api/v3", result, "getApiPath for https failed");
    }
    ...
    public void bitbucketServerTest() {
        ...
        Assertions.assertEquals("http://localhost:8990/rest/api/1.0/projects/proj/repos/rep1", result, "getRepoApiPath for https failed");

        result = handler.getRepoApiPath("http://localhost:8990/scm/~admin/rep1.git");
        Assertions.assertEquals("http://localhost:8990/rest/api/1.0/users/admin/repos/rep1", result, "getRepoApiPath for https failed");
    }

    @Test
    public void bitbucketParseLinks() throws JacksonException {
        ...
        Assertions.assertEquals("ssh://git@myd-hvm02624.swinfra.net:7999/tes/simple-tests.git", links.getSshUrl());
        Assertions.assertEquals("http://myd-hvm02624.swinfra.net:7990/scm/tes/simple-tests.git", links.getHttpUrl());
    }

    @Test
    public void githubServerParseLinks() throws JacksonException {
        ...
        GithubServerFetchHandler handler = new GithubServerFetchHandler(new NoCredentialsStrategy());
        SCMRepositoryLinks links = handler.parseSCMRepositoryLinks(body);
        Assertions.assertEquals("git@github.com:radislavB/trial.git", links.getSshUrl());
        Assertions.assertEquals("https://github.com/radislavB/trial.git", links.getHttpUrl());
    }
}

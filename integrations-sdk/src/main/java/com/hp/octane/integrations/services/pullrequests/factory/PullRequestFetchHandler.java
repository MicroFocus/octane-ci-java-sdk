...
import com.hp.octane.integrations.services.pullrequests.rest.GeneralRestClient;
...
public abstract class PullRequestFetchHandler {

    protected static final DTOFactory dtoFactory = DTOFactory.getInstance();
    protected final GeneralRestClient restClient;

    public PullRequestFetchHandler(AuthenticationStrategy authenticationStrategy) {

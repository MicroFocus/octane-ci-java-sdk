...
public final class EntitiesServiceImpl extends OctaneSDK.SDKServiceBase implements EntitiesService {
    ...
    public EntitiesServiceImpl(Object internalUsageValidator, RestService restService) {
    ...
    public List<Entity> getEntities(Long workspaceId, String entityCollectionName, Collection<String> conditions, Collection<String> fields) {
        ...
        while (!fetchedAll) {
            String url = getEntityUrl(workspaceId, entityCollectionName, conditions, fields, result.size(), limit, null);
            OctaneRequest request = dtoFactory.newDTO(OctaneRequest.class)

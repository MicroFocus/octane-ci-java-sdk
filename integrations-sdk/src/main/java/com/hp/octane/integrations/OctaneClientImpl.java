...
final class OctaneClientImpl implements OctaneClient {
	...
	OctaneClientImpl(OctaneSDK.SDKServicesConfigurer configurer) {
		...
		logger.info("OctaneClient initialized, instance ID: '" + configurer.octaneConfiguration.getInstanceId() + "', shared space ID: " + configurer.octaneConfiguration.getSharedSpace());
	}
